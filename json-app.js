...
{"menu": {
    "header": "JSON Beautifier",
    "items": [
        {"url": "https://fendiali.net/p/json-beautify.html"},
        {"id": "Load"},
        {"id": "LoadJson", "label": "Load JSON"},
        null,
        {"id": "ResetJson", "label": "Reset JSON"},
        ...
        {"id": "CopyJSON", "label": "Copy JSON"},
        {"id": "ViewJSON", "label": "View JSON"},
        {"id": "ViewSource", "label": "View Source"},
        {"id": "SaveAs", "label": "Save As"},
        null,
        {"id": "Help"},
        {"id": "About", "label": "About JSON Beautifier..."}
    ]
}}
